...
# ------------------------------------------------------------
# 🎯 HR Promotions Dashboard (Works only with Final_Promotions_Predicted_Dataset.csv)
# ------------------------------------------------------------
...
if exp_col:
    st.subheader("📌 Promotion by Experience")
    fig3 = px.box(
...
if age_col:
    st.subheader("📌 Promotion by Age / Tenure")
    fig5 = px.box(
